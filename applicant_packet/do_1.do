...
xtset prov_id year
parmby "xtreg saidin treat ib2004.year,vce(cluster prov_id)", label  eform saving(maule_beatrice_estimates.dta)
...
use "/Users/beatricemaule/Desktop/maule_beatrice_estimates.dta", clear
...
replace tr_mean_low=cr_low+tr_lo
replace tr_mean_high=cr_hig+tr_hi
